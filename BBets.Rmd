...
```
28 people in class then the 2:3 bet is about fair.

<!--Explain and display the results of your method of coming up with the estimate of professor Brownlows betting profits!-->

For it to be a fair bet, the graph shows the need to have 28 people in the class, with a 2:3 ratio. 28 partipants is the closest to a fair bet.
